    ...
    <main className="mx-auto flex min-h-screen max-w-4xl items-center px-6 py-16">
      <section className="w-full rounded-3xl bg-white p-8 shadow-sm ring-1 ring-slate-200 sm:p-12">
        ...
        <p className="mt-5 max-w-2xl text-lg leading-8 text-slate-600">
          A self-service application planning platform for Sri Lankan students
          exploring verified German Master&apos;s programmes.
        </p>
  ...
  return (
    <main className="mx-auto max-w-3xl px-6 py-16">
      ...
      <p className="mt-4 leading-7 text-slate-700">
        This route verifies that React Router is configured. Product features
        will be added only in approved development phases.
      </p>
    </main>
  )
}
